...
<style>
  ...
  .product-desc { font-size: 0.82rem; color: var(--text-muted); margin-top: 0.15rem; }
  .product-category {
    font-size: 0.75rem;
    color: #6366f1;
    background: #eef2ff;
  ...
  .product-price { font-weight: 700; color: var(--accent); font-size: 0.95rem; }
  ...
  .avail-toggle.avail,
  .availability-badge.avail { background: var(--success-bg); color: var(--success-text); }
  .avail-toggle.unavail,
  .availability-badge.unavail { background: var(--error-bg); color: var(--error-text); }
